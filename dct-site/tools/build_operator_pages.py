      ...
      <div class="shell form-wrap">
        ...
        <div class="form-card operator-form-card">
          <form action="/submit.php" method="post" data-lead-form>
            ...
            <div class="form-note"><strong>What happens next:</strong> a coach tour specialist will review your preferences and contact you to discuss suitable options. There is no obligation to book.</div>
            ...
            <input type="hidden" name="lead_order_id"><input type="hidden" name="time_on_page"><input type="hidden" name="device_type"><input type="hidden" name="browser_language"><input type="hidden" name="page_load_time"><input type="hidden" name="utm_source"><input type="hidden" name="utm_medium"><input type="hidden" name="utm_campaign"><input type="hidden" name="utm_term"><input type="hidden" name="utm_content"><input type="hidden" name="utm_id"><input type="hidden" name="matchtype"><input type="hidden" name="gad_device"><input type="hidden" name="network"><input type="hidden" name="adgroupid"><input type="hidden" name="targetid"><input type="hidden" name="loc_physical"><input type="hidden" name="loc_interest"><input type="hidden" name="gclid"><input type="hidden" name="gbraid"><input type="hidden" name="wbraid"><input type="hidden" name="click_id"><input type="hidden" name="click_id_type"><input type="hidden" name="landing_page"><input type="hidden" name="referrer"><input type="hidden" name="source_page" value="{source}">
...
<head>
  ...
  <meta name="robots" content="index,follow"><meta name="theme-color" content="#2b123c">
  <link rel="canonical" href="https://book.discountcoachtours.ca/{filename}">
  ...
  <script type="text/javascript">
    ...
    }})(window, document, "clarity", "script", "yfndqty55t");
  </script>
</head>
<body class="operator-page operator-page-{data['slug']}">
  ...
  <div class="shell nav">
    ...
    <div class="desktop-contact" aria-label="Telephone and opening hours"><p>Call us Toll Free<br><a href="tel:+18779778586">1 (877) 977-8586</a></p><p>Monday to Friday 9am to 9pm<br>Saturday &amp; Sunday 9am to 5pm</p></div>
  ...
  <script src="/assets/js/site.js?v=20260905a" defer></script>
</body></html>'''
