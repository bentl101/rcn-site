      ...
      <div class="shell form-wrap">
        ...
        <div class="form-card operator-form-card">
          <form action="/submit.php" method="post" data-lead-form>
            ...
            <input type="hidden" name="lead_order_id"><input type="hidden" name="time_on_page"><input type="hidden" name="device_type"><input type="hidden" name="utm_source"><input type="hidden" name="utm_medium"><input type="hidden" name="utm_campaign"><input type="hidden" name="utm_term"><input type="hidden" name="utm_content"><input type="hidden" name="click_id"><input type="hidden" name="click_id_type"><input type="hidden" name="landing_page"><input type="hidden" name="referrer"><input type="hidden" name="source_page" value="{source}">
...
<body class="operator-page operator-page-{data['slug']}">
  ...
  <script src="/assets/js/site.js?v=20260904a" defer></script>
</body></html>'''
